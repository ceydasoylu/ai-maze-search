export var MazeCreator = {
  ...
  initialize: function (form) {
    ...
    MazeCreator.FORM.END_X = form["endX"];
    MazeCreator.FORM.END_Y = form["endY"];
  ...
  insertGoal: function () {
    let index =
      MazeCreator.FORM.WIDTH * MazeCreator.FORM.END_Y +
      MazeCreator.FORM.END_X;
    MazeCreator.valueArr[index] = "g";
    MazeCreator.indexArr.splice(index, 1);
  },
